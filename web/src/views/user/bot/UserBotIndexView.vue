                                ...
                                <tr v-for="bot in bots" :key="bot.id">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-secondary" style="margin-right: 10px;"
                                            data-bs-toggle="modal" :data-bs-target="'#update-bot-modal-' + bot.id">修改
                                        </button>
                                        <button type="button" class="btn btn-danger" @click="remove_bot(bot)">删除
                                        </button>
...
export default defineComponent({
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://127.0.0.1:3000/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://127.0.0.1:3000/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://127.0.0.1:3000/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://127.0.0.1:3000/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
